...
public class NumberFormattingUnitTest {
    ...
    public void testEngFormat() {
        ...
        assertEquals("12.34567890123e-03", x.toEngString());

        x.set(-1.234567890123456789e-02d);
        assertEquals("-12.34567890123e-03", x.toEngString());

        x.set(0.0123d);
        assertEquals("12.3e-03", x.toEngString());
    }
    ...
    public void testSciFormat() {
        ...
        x.set(1.234567890123456789e-02d);
        assertEquals("1.234567890123e-02", x.toEngString());

        x.set(-123.4567890123456789e-02d);
        assertEquals("-1.234567890123e+00", x.toEngString());

        x.set(456d);
        assertEquals("4.56e+02", x.toEngString());
